...
Then read the [repository engineering standards](../pkg-auth-util-coding-standards-and-best-practices/SKILL.md) before following this workflow.

Mandatory companion: load
`$pkg-auth-util-coding-standards-and-best-practices` before this skill for every
